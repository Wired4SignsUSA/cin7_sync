...
TOOL_SCHEMAS: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "🔀 Mixed / ⚡ Sporadic / 💤 Dormant / 📉 Decline; "
            "Sporadic = sold in 3 or fewer of the last 6 months, "
            "planned on the lower of the 12mo and 6mo rates). "
            "Pass parents_only=true and "
